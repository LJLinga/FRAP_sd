...
if(isset($_POST['btnUpdateGroup'])){
    ...
    header("Location: http://". $_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."/GRP_Group_Settings.php?id=".$groupId);
}
...
if(isset($_GET['id'])){
    ...
    if(!$boolInGroup){
        header("Location: http://" . $_SERVER['HTTP_HOST'] .dirname($_SERVER['PHP_SELF'])."/GRP_Groups.php");
    }
            ...
            <div class="col-lg-12">
                <h3 class="page-header">
                    <div class="form-inline">
                        <a class="btn btn-info" href="GRP_Groups.php"><i class="fa fa-arrow-left"></i> Groups</a>
                        <span id="editName">
                                        ...
                                        <td>
                                            <?php if($boolGroupAdmin){ ?>
                                                <form action="" method="POST">
                                                    ...
                                                    <?php } else if($row['isAdmin'] == '2' && $row['EMP_ID'] !== $userId) { ?>
