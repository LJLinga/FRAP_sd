                            ...
                            <div class="col-lg-12">
                                ...
                                <table id="table" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <td align="center"><?php echo $resultRow['DEDUCTION_DATE']; ?></td>
                                        <td align="center">₱ <?php echo $resultRow['PER_PAYMENT']; ?></td>
                                        <td align="center"><button type='submit' class='btn btn-success' name='toDeductID' value='<?php echo $resultRow['ID']; ?>'>Deduct</button>&nbsp;&nbsp;&nbsp;</td>
